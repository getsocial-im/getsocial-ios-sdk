...
- (void)sendNotificationForMessage:(NSString *)message recipient:(NSString *)recipientId
{
    ...
    GetSocialAction *action = [GetSocialAction actionWithType:@"open_chat_message" data: messageMetadata];
    ...
    GetSocialSendNotificationTarget* target = [GetSocialSendNotificationTarget usersWithIds:[GetSocialUserIdList create:@[ recipientId ]]];

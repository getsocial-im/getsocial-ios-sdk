...
- (void)viewDidLoad
{
    ...
    self.types = @{
        ...
        GetSocialNotificationTypeSDK : @"SDK"
    };
    ...
    self.statuses = @[
        GetSocialNotificationStatusRead, GetSocialNotificationStatusUnread, GetSocialNotificationStatusConsumed, GetSocialNotificationStatusIgnored
    ];
